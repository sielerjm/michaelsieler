...
Postdoctoral researcher at the University of Geneva (2026–present)
------------------------------------------------------------------

Introduction
------------

I'm a microbiome data scientist and postdoctoral researcher in the `Liberti Lab <https://genev.unige.ch/research/laboratory/joanito-liberti>`_ at the University of Geneva, Department of Genetics and Evolution. I earned my Ph.D. in Microbiology from Oregon State University in 2025 and completed a postdoctoral year in the Sharpton Lab before relocating to Geneva.

My current research investigates the social microbiome and gut microbiota–brain axis of eusocial bee model systems, extending my graduate work on host-associated microbiome stability, multi-omic integration, and environmental stressors.

Research Interests
------------------

- **Host–microbiota interactions and behavior**: How gut microbiota relate to social behavior and host health in eusocial systems
- **Temporal stability of microbiome systems**: Frameworks for evaluating longitudinal patterns of microbiome stability and transmission
- **Multi-omic microbiome analysis**: Integrating multivariate multi-omic data to clarify patterns and mechanisms of microbiome dynamics
- **Transdisciplinary microbiome research**: Collaborating across disciplines to connect microbiome science with public health and equity
...
In my postdoctoral fellowship, I aim to:

- Investigate ecological, developmental, and social determinants of microbial transmission in eusocial bees
- Expand integrative multi-omic and reproducible analytical workflows for host–microbiota research
- Collaborate across international teams in genetics, evolution, and microbiome science
